          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg relative">
              <div className="absolute -top-5 left-6">
                <Link
                  href="#"
                  className="bg-white px-6 py-2 rounded-lg shadow-md border font-semibold text-gray-700 hover:bg-gray-50"
                >
                  Form ULOK
                </Link>
              </div>
              <div className="pt-8">
                ...
                <div className="mt-8 pt-6 border-t">
                  <a
                    ...
                    className="flex items-center justify-center w-full bg-blue-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors text-lg"
                  >
                    <svg
