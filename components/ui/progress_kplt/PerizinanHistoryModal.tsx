...
const FileLink: React.FC<{
  ...
  // Buat URL API file. Asumsi modulnya 'perizinan'.
  const href = fileKey
...
export function PerizinanHistoryModal({
  ...
  // Urutkan data sekali di sini, DARI LAMA KE BARU (untuk perbandingan)
        ...
        <div className="p-6 lg:p-8 space-y-4 overflow-y-auto">
          {isLoading ? (
            ...
            <div className="flow-root">
              <div className="-mb-4">
                {/* Balik array yang sudah diurutkan (sortedHistory)
                  agar item TERBARU tampil di ATAS.
                */}
