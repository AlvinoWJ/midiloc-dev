...
function getChanges(
  ...
  const fieldLabels: Record<string, string> = {
    ...
    tipe_toko: "Tipe Toko",
    bentuk_objek: "Bentuk Objek",
    rekom_renovasi: "Rekom Renovasi",
    tgl_rekom_renovasi: "Tgl Rekom Renovasi",
    start_spk_renov: "Start SPK",
    end_spk_renov: "End SPK",
    plan_renov: "Plan Renovasi",
    proses_renov: "Proses Renovasi",
    deviasi: "Deviasi",
    tgl_serah_terima: "Tgl Serah Terima",
    file_rekom_renovasi: "File Rekom Renovasi",
  };
...
interface RenovasiItemProps {
  item: RenovasiHistoryItem;
  previousItem: RenovasiHistoryItem | null;
  onSelect: () => void;
}
    ...
    <>
      ...
      <div className="p-6 lg:p-8 space-y-6 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <DetailField
            label="Tgl Rekom Renovasi"
            value={formatDateOnly(data.tgl_rekom_renovasi)}
          />
          <DetailField
            label="Start SPK"
            value={formatDateOnly(data.start_spk_renov)}
          />
          <DetailField
            label="End SPK"
            value={formatDateOnly(data.end_spk_renov)}
          />
          <DetailField label="Plan Renovasi (hari)" value={data.plan_renov} />
          <DetailField label="Proses Renovasi (%)" value={data.proses_renov} />
          <DetailField label="Deviasi (%)" value={data.deviasi} />
          <DetailField
            label="Tgl Serah Terima"
            value={formatDateOnly(data.tgl_serah_terima)}
          />
          <DetailField label="Status Final" value={data.final_status_renov} />
          <DetailField
            label="Tanggal Selesai"
            value={formatDateOnly(data.tgl_selesai_renov)}
          />
        </div>
        ...
        <div className="space-y-3">
          ...
          <FileLink
            ...
            fileKey={data.file_rekom_renovasi}
